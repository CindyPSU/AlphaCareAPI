...
1. **System Reports** 
- Simplify requirement to address new system usage by medical staff
...
View/Create Patient Medical Record
...
4. An empty Patient Medical Record will display and you can input and complete the Patient Information section.
5. Click Save and the new patient will be stored in the Application database.
